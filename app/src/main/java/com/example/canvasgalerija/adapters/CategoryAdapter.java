...
public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.ViewHloder> {
    ...
    public ViewHloder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHloder(LayoutInflater.from(parent.getContext()).inflate(R.layout.category_list,parent,false));
    }
